...
def faceDetection(test_img):
    ...
    face_haar_cascade=cv2.CascadeClassifier('E:/Data Science/PDF/computer vision/FaceRecognition-master/FaceRecognition-master/HaarCascade/haarcascade_frontalface_default.xml')#Load haar classifier
...
def put_text(test_img,text,x,y):
    cv2.putText(test_img,text,(x,y),cv2.FONT_HERSHEY_DUPLEX,1,(255,255,0),3)
